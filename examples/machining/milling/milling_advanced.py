...
percent_volume_removed.update(round((volume_removed / bbox) * 100, 3))
...
# The higher the runtime multiplier, the more difficult the material is to remove.
# Note that by using part.material_family, we are simply looking to see if the
# respective word (e.g. 'Aluminum' or 'Stainless Steel') appears in the material_family name.
