...
set_workpiece_value('Total Setup Time', get_workpiece_value('Total Setup Time', 0) + setup_time)
set_workpiece_value('Operation Count', get_workpiece_value('Operation Count', 0) + 1)